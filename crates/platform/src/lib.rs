...
#[cfg(windows)]
pub use environment::{detect_windows_claude_in_localappdata, detect_windows_claude_in_windowsapps};
pub use logging::{FileLogger, run_command};
pub use paths::{
    cc_switch_skills_dir, claude_config_paths, config_library_paths, skills_plugin_root, user_home,
};
pub use resources::{
    install_resource_update, resource_candidates, resource_release_manifest, resolve_resources,
